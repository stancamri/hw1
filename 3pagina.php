...
<head>
    ...
    <link rel="stylesheet" href="3pagina.css" />
   <script src="3pagina.js" defer></script>
   


    <title> Archivi Circolari Scolastiche</title> <meta name="viewport" content="width=device-width, initial-scale=1">
...
<body>
      ...
      <div id="flex-container3">
        ...
        <section> 
        <div id="sec">
        <div class=" sec1"> <a href="#"> HOME </a> </div> 
        <div class="sec2"> <a href="#"> / Novità </a></div> 
        <div class="sec2">  / Circolari </div> 
    </div>
</section>
<section>
  <div class="circolari">
  ...
  <section id="sezione_circ">
    <div id="circolari">
        <div class="tipologia">
            <h1>Tipologia</h1>
            <label class="checkbox-label">
                <input type="checkbox" name="circolari" value="alunni" class="round-checkbox"> Circolari per Alunni
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="circolari" value="genitori" class="round-checkbox"> Circolari per Genitori
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="circolari" value="docenti" class="round-checkbox"> Circolari per Docenti
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="circolari" value="ATA" class="round-checkbox"> Circolari per ATA
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="circolari" value="tutte" class="round-checkbox"> Mostra Tutte
            </label>    </div>
        <div id="circolariVisualizzate">
            <!-- Qui verranno visualizzate le circolari filtrate -->
        </div>
