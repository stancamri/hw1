...
<html>
  <head>
    <meta charset="utf-8">
   <title> Liceo Statate Leonardo </title>
   <link rel="stylesheet" href="index.css" />
   <script src="index.js" defer></script>
   <meta name="viewport" content="width=device-width, initial-scale=1">
   <link rel="preconnect" href="https://fonts.googleapis.com">
   <script src="https://cdn.jsdelivr.net/npm/@tomtom-international/web-sdk-services@7/dist/services-web.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/@tomtom-international/web-sdk-maps@6/dist/maps-web.min.js"></script>
</body>
 ...
 <div id="modaleCerca" class="modale2">
  <div class="cont-modale2">
   ...
   <form action="searchResults.php" method="get">
            <input type="text" name="query" placeholder="Inserisci il titolo del libro...">
...
<div id="flex-container3">
  ...
  <!--  inizio 3 campo -->
 <div id="sezione1">
  <p>PROTOCOLLO BULLISMO E CYBERBULLISMO <a href="https://acrobat.adobe.com/id/urn:aaid:sc:EU:d96439b2-3a98-4591-ae29-07cc6f37c9e6"> Dettagli</a></p>
 </div>
   <!--  fine 3 campo -->
      <!--  inizio 4 campo -->

 <div id="flex-container4">
  <div class="flex-items4 ite1">
    <p> Liceo Statale</p>
   <h1> Leonardo</h1>
   <h3>Giarre</h3>
   <div> <a href="https://www.liceoleonardo.edu.it/wp/la-scuola/"> Vai alla scuola </a></div>
  </div>
  <div class="flex-items4 ite2"> 
    <img src="foto7.png">
...
<!--  fine 4 campo -->
<section>
  <div id="secart"><p>Pubblicità e Informazione</p></div>
  <div id="art">
    <div class="art1">
      <img src="pics4.png">
    </div>
...
<section>
  <div id="box">
    ...
    <br/>
  <div class="bo3"><a href="4pagina.php"> Vedi tutti</a></div>
    </div>
    <div class="box2">
      <h4>Eventi</h4>
      <div class=boxx><a href="https://www.liceoleonardo.edu.it/wp/evento/"> Vedi tutti </a></div>
    </div>
    <div class="box3">
      <h4>Circolari</h4>
      <article>
      <div id="ultima-circolare-container">
      <?php
            $isHomePage = true;
            include 'circolari.php';
            ?>
      </div>
    </article><br/>
    <div class="bo4"><a href="3pagina.php"> Vedi tutti </a></div></div>
      </div>
...
<br>
  <div id="cont">
    <div class="scritta">
  <h1>  Servizi</h1>
  <h2>I servizi offerti dal Liceo Statale Leonardo dedicati a tutti i genitori, studenti, personale ATA, docenti ed utenze esterne.</h2>
</div>
</div>
<div> 
  <div id="cas">
    <div class="casella cas1" >
<a   href="https://www.liceoleonardo.edu.it/wp/servizio/argo-mad/"> Argo MAD</a>   
   </div>
    <div class="casella cas2">
<a  href="https://www.liceoleonardo.edu.it/wp/servizio/avviso-di-consultazione-pubblica-dellaggiornamento-del-piano-triennale-per-la-prevenzione-della-corruzione-e-della-trasparenza-delle-istituzioni-scolastiche-della-regione-sicilia-2023-2025/">AVVISO di consultazione pubblica dell’aggiornamento del Piano Triennale per la Prevenzione della Corruzione e della Trasparenza delle Istituzioni scolastiche della regione Sicilia 2023-2025</a> 
    </div>
    <div class="casella cas3">
<a href="https://www.liceoleonardo.edu.it/wp/servizio/codice-iban-scuola/"> Codice IBAN scuola</a>
    </div>
    <div class="casella cas4">
<a href="https://www.liceoleonardo.edu.it/wp/servizio/formazione-neoassunti-a-s-2021-2022-2/">Formazione neoassunti A.S. 2021/2022 </a>
    </div>
    <div class="casella cas5">
<a href="https://www.liceoleonardo.edu.it/wp/servizio/orario-docenti-dal-13-09-2021/">Orario docenti dal 13.09.2021</a>
    </div>
    <div class="casella cas6">
<a href="https://www.liceoleonardo.edu.it/wp/servizio/orario-classi-dal-13-09-2021/"> ORARIO CLASSI DAL 13.09.2021 </a>
    </div>
    </div>
    <div class="pulsante">
    <a href="https://www.liceoleonardo.edu.it/wp/servizi/"> Scopri di più</a>
  </div>
</div>
<!--  fine 6 campo --> 
<!--  inizio 7 campo --> 
<section>
  <div id="conteni">
    <div class="contenente cont1">
      <h1> La scuola</h1>
      <h2> A.S.</h2>
      <div class="cont11">
        <a href="https://www.liceoleonardo.edu.it/wp/#tab-818"> Liceo Statale Leonardo</a>
      </div>
      <div class="conim"> <img src="https://www.liceoleonardo.edu.it/wp/wp-content/themes/design-scuole-wordpress-theme-master/assets/img/didattica-mockup.png">
      </div>
    </div>
    <div class="contenente cont2">
      <h1> La didattica</h1>
      <h2> la nostra offerta formativa</h2>
      <h3> Nessun indirizzo di studi associato a questa scuola.</h3>
      <br/>
        <a href="https://www.liceoleonardo.edu.it/wp/struttura/liceo-statale-leonardo/"> Vai alla presentazione della scuola</a>
    </div>
  </div>
</section>
<!--  fine 7 campo --> 
...
<div id="finale">
  <div class="part part1">
    <h6>Didattica</h6>
    <p>Esplora le risorse didattiche dell'Istituto</p>
    <div class="impim"><a href="https://www.liceoleonardo.edu.it/wp/didattica/"> Vai alla didattica </a></div>
  </div>
  <div class="part part2">
    <a href="https://www.liceoleonardo.edu.it/wp/scheda-progetto/"> <img src="pics2.jpeg"></a> 
   <div class="pro"><a href="https://www.liceoleonardo.edu.it/wp/scheda-progetto/"> <p>Progetti </p> </a></div> 
  </div>
