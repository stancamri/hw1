...
<head>
    ...
    <link rel="stylesheet" href="4pagina.css" />
   <script src="4pagina.js" defer></script>
   


    <title> Rassegna Stampa Archivi</title> <meta name="viewport" content="width=device-width, initial-scale=1">
...
<body>
      ...
      <div id="flex-container3">
        ...
        <section> 
        <div id="sec">
        <div class=" sec1"> <a href="index.php"> HOME </a> </div> 
        <div class="sec2"> <a href="#"> / Novità </a></div> 
        <div class="sec2">  / Rssegna Stampa </div> 
    </div>
</section>
<section>
  <div class="rassegna">
...
<section id="sezione_rassegna">
    <div id="rassegna">
        <div class="tipologia">
            <h1>Tipologia</h1>
            <label class="checkbox-label">
                <input type="checkbox" name="tipologia" value="Articoli" class="round-checkbox"> Articoli
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="tipologia" value="Notizie" class="round-checkbox"> Notizie
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="tipologia" value="OpenDay" class="round-checkbox"> Open Day
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="tipologia" value="PTOF" class="round-checkbox"> PTOF
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="tipologia" value="Rassegnastampa" class="round-checkbox"> Rassegna stampa
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="tipologia" value="RAV" class="round-checkbox"> RAV (Rapporto di autovalutazione)
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="tipologia" value="tutte" class="round-checkbox"> Mostra Tutte
            </label>
        </div>
        <div id="rassegneVisualizzatte">
            <!-- Qui verranno visualizzate le rassegne filtrate -->
        </div>
